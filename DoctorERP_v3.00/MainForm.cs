...
using DoctorERP_v3_00.Properties;
...
namespace DoctorERP_v3_00
{
    public partial class MainForm : RadForm
    {
        ...
        {
            InitializeComponent();
            //ThemeResolutionService.LoadPackageResource(Application.StartupPath + "\\Themes\\MedicalAppTheme.tssp");
            RadMessageBox.Instance.ThemeName = "windows11";
